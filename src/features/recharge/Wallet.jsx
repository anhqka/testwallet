    ...
    return (
        <Container>
            ...
            <FlexRow botom="0" justifyContent="center" bg="#004766" position="fixed" z="50" pb="16px" pt="16px">
                <ButtonStyle onClick={() => setVisible(true)} disabled={!allowContinue} bg={allowContinue} w="88%" bRadius="16px" p="16px" color="#015A80" textSize="16px" textWeight="500">Tiếp tục</ButtonStyle>
            </FlexRow>
            <ActionSheet
                extra='请选择你要进行的操作'
                cancelText='取消'
